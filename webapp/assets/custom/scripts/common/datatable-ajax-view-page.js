define(function() {
	...
	var handleRecords = function(tableId, AjaxURL, aoColumns, callback,callbackFun,rowCallback) {
	...
	return {
		...
		init : function(tableId, AjaxURL, aoColumns, callback, callbackFun, rowCallback) {
			return handleRecords(tableId, AjaxURL, aoColumns, callback, callbackFun, rowCallback);
		},
		//加载完成回调(行)
		initRowCallback : function(tableId, AjaxURL, aoColumns,rowCallback) {
			return handleRecords(tableId, AjaxURL, aoColumns,null,null,rowCallback);
		},
		//加载完成回调
