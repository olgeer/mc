define(['datatable_ajax_jsonp'], 
	...
	function getAoData(params) {
		...
		},
		{
			...
			"mRender" : function(data,type,full){
				var str = '';
				params.hasEdit && (str += '<a class="btn btn-xs blue ajaxify" module_id="module_certificate_edit_' + data + '" href="configuration/certificate/' + data + '?displayName=Http证书"><i class="fa fa-pencil"></i> 编辑</a>');
	...
	var initDataTableAjax = function(params){
		tableObj = DataTableAjaxJsonp.init("#certificate_datatable_" + params.uuid, cmdbHost + "/mc?_tablename=certificate&_action=get", getAoData(params));
	};
