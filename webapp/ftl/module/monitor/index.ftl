<!DOCTYPE html>
  ...
  <body>
	...
	<div class="page-container">
		<div style="">
			<div class="page-content" style="position: relative;padding: 0px 20px 10px 20px;">

				<div id="page-content-body-tabs">
					<!-- Nav tabs -->
					<ul class="nav nav-tabs" role="tablist" style="position: fixed;top: 0px;left: 20px;right: 20px;z-index: 1;background: #fff;">
					</ul>
					<!-- Tab panes -->
