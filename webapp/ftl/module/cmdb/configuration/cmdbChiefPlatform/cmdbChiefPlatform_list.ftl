	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-building-o"></i>项目列表
				</div>
			</div>
			<div class="portlet-body">
				<div class="table-toolbar">
					<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_APPLICATION_CMDBCHIEFPLATFORM_EDIT">
						<div class="btn-group">
							<a class="btn yellow ajaxify" module_id="module_cmdbChiefPlatform_add" href="configuration/cmdb_chief_platform/add?displayName=项目">
				...
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover" id="cmdbChiefPlatform_datatable_${uuid}">
						<thead>
...
<script src="${base}/assets/custom/scripts/cmdb/configuration/cmdbChiefPlatform/cmdbChiefPlatform_list_main.js"></script>
<#--END PAGE JAVASCRIPT-->
<script type="text/javascript">
	require(["jquery", "cmdbChiefPlatform_list_init","jquery_validator_messages", "bootstrap_datepicker", "bootstrap_modal"],
		function($, cmdbChiefPlatformListInit) {
			$(document).ready(function() {
				Metronic.init();
				cmdbChiefPlatformListInit.init({
					uuid: '${uuid}',
					hasEdit: '<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_APPLICATION_CMDBCHIEFPLATFORM_EDIT">true</@security.authorize>'
				});
			});
		});
</script>