			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_MANAGEMENT_EDIT">
						<div class="btn-group">
							<a class="btn yellow ajaxify" module_id="module_device_brand_add" href="configuration/device_brand/add?displayName=设备品牌">
...
<#--END PAGE JAVASCRIPT-->
<script>
	require(["jquery", "../custom/scripts/cmdb/configuration/device_brand/device_brand_list_init"], function($, page) {
		$(function() {
			Metronic.init();
			page.init({
				uuid: '${uuid}',
