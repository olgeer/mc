<table class="table table-bordered table-striped">
    ...
    <tr v-for="detail in details">
        ...
        <td>
            <div v-if="detail.state==1 || detail.state==21 || detail.state==3 || detail.state==41">
                <label class="control-label">{{detail.ser_time}}</label>
            </div>
            <div v-else>
                <label class="control-label">{{detail.assign_time}}</label>
            </div>
        </td>
    </tr>
    </tbody>
