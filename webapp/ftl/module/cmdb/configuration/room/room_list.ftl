			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_BASIS_ROOM_EDIT">
						<div class="btn-group">
							<a class="btn yellow ajaxify" module_id="module_room_add" href="configuration/room/add?displayName=机房">
				...
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover" id="room_datatable_${uuid}">
						<thead>
							...
							<tr role="row" class="filter">
								<td>
									<input type="text" class="form-control form-filter input-sm" name="roomname">
								</td>
								<td>
...
<script src="${base}/assets/custom/scripts/cmdb/configuration/room/room_list_main.js"></script>
<#--END PAGE JAVASCRIPT-->
<script type="text/javascript">
	require(["jquery", "room_list_init","jquery_validator_messages", "bootstrap_datepicker", "bootstrap_modal"],
		function($, roomListInit) {
			$(document).ready(function() {
				Metronic.init();
				roomListInit.init({
					uuid: '${uuid}',
					hasEdit: '<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_BASIS_ROOM_EDIT">true</@security.authorize>'
				});
			});
		});
</script>