			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<@security.authorize ifAnyGranted="ROLE_COMPANY_EDIT">
						<div class="btn-group">
							<a class="btn yellow ajaxify" module_id="module_user_add" href="configuration/t_user/add?displayName=">
							<i class="fa fa-plus-square-o"></i> 添加用户
							</a>
						</div>
					</@security.authorize>
				</div>
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover" id="user_datatable_${uuid}">
						<thead>
							...
							<tr role="row" class="filter">
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="referer_code">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="refer_id">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="company_name">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="pay_amount">
								</td>
								<td>
...
<script src="${base}/assets/custom/scripts/cmdb/configuration/user/user_list_main.js"></script>
<#--END PAGE JAVASCRIPT-->
<script type="text/javascript">
	require(["jquery", "user_list_init","jquery_validator_messages", "bootstrap_datepicker", "bootstrap_modal"],
