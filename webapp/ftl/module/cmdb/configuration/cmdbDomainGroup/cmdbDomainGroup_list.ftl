		...
		<div class="portlet box blue">
			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_BASIS_CMDBDOMAINGROUP_EDIT">
						<div class="btn-group btn-group-sm">
							<a class="btn yellow ajaxify" module_id="module_cmdb_domain_group_add" href="configuration/cmdb_domain_group/add?displayName=域组">
								<i class="fa fa-plus-square-o"></i> 添加域组
							</a>
						</div>
					</@security.authorize>
					<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_BASIS_CMDBDOMAINGROUPHOST_ADD">
						<div class="btn-group btn-group-sm">
							<a class="btn yellow ajaxify" module_id="module_cmdb_domain_group_with_host_add" href="configuration/cmdb_domain_group_with_host/add?displayName=域组主机关联">
					...
					<table class="table table-striped table-bordered table-hover" id="${uuid}">
						<thead>
							...
							<tr role="row" class="filter">
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="cni.ip">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="cdg.group_name">
								</td>
...
<#--END PAGE JAVASCRIPT-->
<script>
	require(["jquery", "../custom/scripts/cmdb/configuration/cmdbDomainGroup/cmdbDomainGroup_list_init"], function($, page) {
		$(function() {
			Metronic.init();
			page.init({
				uuid: '${uuid}',
				hasEdit: '<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_BASIS_CMDBDOMAINGROUPHOST_ADD">true</@security.authorize>'
			});
		});
	});
</script>