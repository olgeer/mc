	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-building-o"></i>平台列表
				</div>
			</div>
			<div class="portlet-body">
				<div class="table-toolbar">
					<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_APPLICATION_CHIEFPLATFORM_EDIT">
						<div class="btn-group">
							<a class="btn yellow ajaxify" module_id="module_chiefplatform_add" href="configuration/chief_platform/add?displayName=项目">
							<i class="fa fa-plus-square-o"></i> 添加平台
							</a>
						</div>
					</@security.authorize>
				</div>
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover" id="chiefplatform_datatable_${uuid}">
						<thead>
...
<script src="${base}/assets/custom/scripts/cmdb/configuration/chiefplatform/chiefplatform_list_main.js"></script>
<#--END PAGE JAVASCRIPT-->
<script type="text/javascript">
	require(["jquery", "chiefplatform_list_init","jquery_validator_messages", "bootstrap_datepicker", "bootstrap_modal"],
		function($, chiefplatformListInit) {
			$(document).ready(function() {
				Metronic.init();
				chiefplatformListInit.init({
					uuid: '${uuid}',
					hasEdit: '<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_APPLICATION_CHIEFPLATFORM_EDIT">true</@security.authorize>'
				});
			});
		});
</script>