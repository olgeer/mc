	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-sitemap"></i>设备管理列表
				</div>
			</div>
			<div class="portlet-body">
				<div class="table-toolbar">
					<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_BASIS_CMDBDEVICEINFORMATION_EDIT">
						<div class="btn-group">
							<a class="btn yellow ajaxify" module_id="module_cmdbDeviceInformation_add" href="configuration/cmdb_device_information/add?displayName=设备">
				...
				<div class="table-container">
					<table class="table table-striped table-bordered table-hover" id="cmdbDeviceIn_datatable_${uuid}">
						<thead>
							...
							<tr role="row" class="filter">
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="area_name">
								</td>
                                <td>
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="oob_adress">
								</td>
                                <td>
                                    <input type="text" class="form-control form-filter input-sm" name="cc.line" placeholder="第几列">
                                    <input type="text" class="form-control form-filter input-sm" name="cc.number" placeholder="编号">
                                </td>
...
<script src="${base}/assets/custom/scripts/cmdb/configuration/cmdbDeviceIn/cmdbDeviceIn_list_main.js"></script>
<#--END PAGE JAVASCRIPT-->
<script type="text/javascript">
    require(["jquery", "cmdbDeviceIn_list_init","jquery_validator_messages", "bootstrap_datepicker", "bootstrap_modal"],
            function($, cmdbDeviceInListInit) {
                $(document).ready(function() {
                    Metronic.init();
                    cmdbDeviceInListInit.init({
                        uuid: '${uuid}',
                        hasEdit: '<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_BASIS_CMDBDEVICEINFORMATION_EDIT">true</@security.authorize>'
                    });
                });
            });
</script>
