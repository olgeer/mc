					...
					<table class="table table-striped table-bordered table-hover" id="${uuid}">
						<thead>
							...
							<tr role="row" class="filter">
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="src_host">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="src_ip">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="dst_host">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="dst_ip">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="policy_protocol">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="port">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="start_date">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="end_date">
								</td>
								<td>
									<@dictSelect name="state" type="network_policy_state" class="form-control form-filter input-sm" />
								</td>
...
<#--END PAGE JAVASCRIPT-->
<script>
	require(["jquery", "../custom/scripts/cmdb/configuration/network_policy/network_policy_list_init"], function($, page) {
		$(function() {
			Metronic.init();
			page.init({
				uuid: '${uuid}',
				hasEdit: '<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_NETWORK_NETWORKPOLICY_EDIT">true</@security.authorize>'
			});
		});
	});
</script>