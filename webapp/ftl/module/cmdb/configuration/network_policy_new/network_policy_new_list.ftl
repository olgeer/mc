	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-archive"></i>网络策略列表
				</div>
			</div>
			<div class="portlet-body">
				<div class="table-toolbar">
					<#-- <@security.authorize ifAnyGranted="ROLE_CONFIGURATION_APPLICATION_APPTYPE_EDIT"> -->
						<div class="btn-group">
							<a class="btn yellow ajaxify" module_id="module_network_policy_add" href="configuration/cmdb_network_policy/add?displayName=网络策略">
					...
					<table class="table table-striped table-bordered table-hover" id="${uuid}">
						<thead>
							...
							<tr role="row" class="filter">
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="dst_port">
								</td>
								<td>
									<@dictSelect name="action" type="cnsc_strategy_movement" class="form-control  form-filter input-sm"/>
								</td>
								<td>
...
<script>
	require(["jquery", "../custom/scripts/cmdb/configuration/network_policy_new/network_policy_new_list_init"], function($, page) {
		$(function() {
			Metronic.init();
			page.init({
				uuid: '${uuid}',
