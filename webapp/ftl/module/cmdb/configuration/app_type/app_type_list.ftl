			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<@security.authorize ifAnyGranted="ROLE_CONFIGURATION_APPLICATION_APPTYPE_EDIT">
						<div class="btn-group">
							<a class="btn yellow ajaxify" module_id="module_app_type_add" href="configuration/app_type/add?displayName=应用类型">
					...
					<table class="table table-striped table-bordered table-hover" id="${uuid}">
						<thead>
							...
							<tr role="row" class="filter">
								<td>
									<input type="text" class="form-control form-filter input-sm" name="app_type">
								</td>
								<td>
...
<#--END PAGE JAVASCRIPT-->
<script>
	require(["jquery", "../custom/scripts/cmdb/configuration/app_type/app_type_list_init"], function($, page) {
		$(function() {
			Metronic.init();
			page.init({
				uuid: '${uuid}',
