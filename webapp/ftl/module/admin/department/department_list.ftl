					...
					<table class="table table-striped table-bordered table-hover"
						...
						<thead>
							...
							<tr role="row" class="filter">
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="depa_parent_name">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="depa_parent_no">
								</td>
